...
def _build_prompt(
    ...
    return (
        ...
        "Choose insertion points based on when the speaker finishes a sentence. "
        "Look for pauses between sentences. Choose points where the waveform is lowest. "
        "Always strive for insertion points in the middle of the audio clip, "
        "and never choose the start or the end of the audio clip unless absolutely necessary "
